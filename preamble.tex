...
\setbeamertemplate{itemize item}{\raisebox{1pt}{\scalebox{0.6}{$\blacktriangleright$}}}
\setbeamertemplate{itemize subitem}{\raisebox{1pt}{\scalebox{0.5}{$\blacktriangleright$}}}
\setbeamertemplate{itemize subsubitem}{\raisebox{1pt}{\scalebox{0.4}{$\blacktriangleright$}}}

% Adding page numbers to the footline
